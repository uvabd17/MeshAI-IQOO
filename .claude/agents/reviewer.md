...
3. **Design of record** — `docs/MESHAI.md (§10 design)` and `docs/MESHAI.md (§11 decisions)`. Flag any drift; drift is not automatically wrong, but it needs a DECISIONS entry.
