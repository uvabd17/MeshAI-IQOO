...
| 2026-09-24 | split via meshd (round-3 build, proc_lock): laptop host 7 layers + sim workers 19 + 2 | IdeaPad 3, gradle idle | Qwen3-0.6B Q8_0 | 2048 | 4 | CPU+RPC `-ngl 22 -ot output\.weight=CPU` | loopback | 121.1 (server) | 22.5 (server) / 23.6 (client) | 228 ms | browser chat, 24 tokens; ready in 2.0 s | admin-qa.mjs, split-sim.sh | 66fba63 |
